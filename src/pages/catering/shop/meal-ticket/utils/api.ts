...
export const getTicketTotals = async (): Promise<number[]> =>
  await http("catering/merchant/meal_ticket/totals");
...
export const getTicketList = async (
  ...
  const { list = [] } =
    (await http("catering/merchant/meal_ticket/list", {
...
export const offShelfTicket = async (id: number) =>
  await http("catering/merchant/meal_ticket/down", {
    method: "POST",
    data: { id },
  });

export const onShelfTicket = async (id: number) =>
  await http("catering/merchant/meal_ticket/up", {
    method: "POST",
    data: { id },
  });

export const deleteTicket = async (id: number) =>
  await http("catering/merchant/meal_ticket/delete", {
    method: "POST",
    data: { id },
  });

export const getTicketInfo = async (id: number): Promise<TicketInfo> =>
  await http("catering/merchant/meal_ticket/detail", { data: { id } });

export const createTicket = async (
  ticketInfo: Partial<Omit<TicketInfo, "id">>
) =>
  await http("catering/merchant/meal_ticket/add", {
    method: "POST",
    data: cleanObject(ticketInfo),
  });

export const editTicket = async (ticketInfo: Partial<TicketInfo>) =>
  await http("catering/merchant/meal_ticket/edit", {
    method: "POST",
    data: cleanObject(ticketInfo),
  });
