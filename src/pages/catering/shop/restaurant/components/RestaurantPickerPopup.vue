  ...
  >
    <div class="container">
      ...
      <form action="/">
        <Search
          v-model="keywords"
          @search="setRestaurantOptions"
          placeholder="搜索门店"
        />
      </form>
      <div class="restaurant-options" v-if="restaurantOptions.length">
      ...
      <Empty
        v-if="!restaurantOptions.length"
        image="https://static.tiddler.cn/mp/default_illus/empty.png"
        description="未搜索到相关门店"
      />
      <div class="no-tips row center" @click="createRetaurant">
...
import { getRestaurantOptions } from "../utils/api";
...
const keywords = ref("");
const restaurantOptions = ref<ApiOption[]>([]);
...
const createRetaurant = () => router.push("/catering/shop/restaurant/create");
</script>
